...
THEMES = {
    ...
    "Cool Gray": {
        ...
        "--bg-secondary": "#D9EAFD",
        "--accent": "#9AA6B2",
        "--accent-rgb": "154, 166, 178",
        "--text-primary": "#1E293B", 
        "--text-bright": "#0F172A",
        "--btn-text": "#FFFFFF",
        "--card-bg": "rgba(217, 234, 253, 0.65)",
        "--border-color": "#BCCCDC",
        ...
        "--bg-neutral": "rgba(154, 166, 178, 0.15)",
        "--sidebar-link-bg": "rgba(217, 234, 253, 0.5)",
        "--sidebar-link-text": "#1E293B",
        "--sidebar-link-hover-bg": "#9AA6B2",
        "--sidebar-link-hover-text": "#FFFFFF",
        "--sidebar-link-active-bg": "#9AA6B2",
        "--sidebar-link-active-text": "#FFFFFF",
        "--sidebar-link-border": "#BCCCDC"
    },
